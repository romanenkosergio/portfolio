...
const Contact = () => {
  ...
  const [code, setCode] = useState(`const button = document.querySelector('#sendBtn');
    ...
    <div className="contact">
      <div className="contact-drawer drawer">
        ...
        <Accordion title="find-me-also-in">
          <div className="contact-drawer__content">
            <a href="https://www.instagram.com/romanenkosergio" target="_blank" rel="noreferrer">
              <RiExternalLinkFill className="icon"/>
              <span>Instagram account</span>
            </a>
            <a href="https://djinni.co/q/6e7150fa46/" target="_blank" rel="noreferrer">
              <RiExternalLinkFill className="icon"/>
        ...
        <div className="contact__container page-content">
          <div className="contact__left">
            <form action="" className="contact-form" onSubmit={onSubmit}>
                ...
                <Input
                  ...
                  register={{
                    ...register('name', {
                      ...
                      validate: {
                        minLength: (v) => v.length >= 5 || "The _name should have at least 5 characters",
                        matchPattern: (v) => /^[a-zA-Z]+$/.test(v) || "_name must contain only letters"
                      },
                    })
                  }}/>
              </Label>
                ...
                <Input
                  ...
                  register={{
                    ...register('email', {
                      ...
                      validate: {
                        maxLength: (v) =>
                          v.length <= 50 || "The _email should have at most 50 characters",
                        matchPattern: (v) =>
              ...
              <Button text="submit-message" buttonType="submit" id="#sendBtn"/>
            </form>
          </div>
